...
const pageTitle = from === 'list' || from === 'add' ? "ToDo Details" : "ToDo's Found for This Date";
  return (
    <LinearGradient
    ...
    >
        <View className="flex-1 p-3 pt-20">
          <ToDoDetailsCard pTodoId={id} pPageTitle={pageTitle}/>
          <TouchableOpacity
            ...
            onPress={() => {
              if (from === 'list') {
                ...
                router.push(`${from}`); //Eger [id] sayfasina, list veya add ana sayfalarindan gelmiyorsam, [day] sayfasindan geliyorumdur. Bu satir beni yine ayni gunun sayfasina goturur.
              } else {
