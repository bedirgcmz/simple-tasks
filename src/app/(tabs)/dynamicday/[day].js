...
const DaysTodos = () => {
  ...
  return (
    ...
    <ScrollView className="mt-12 flex-1 z-10 max-h-[80%] " style={{paddingBottom:20}}>
      ...
      <TouchableOpacity
            className="bg-[#001d3d] h-10 w-[110px] pb-2 pr-4 rounded-full items-center flex-row gap-2 justify-center absolute bottom-[140px] right-[36%] z-30" 
            onPress={() => router.back()}
