    ...
    >
      ...
      <View className="text-[12px] mb-1 text-white justify-start items-center flex-row">
        ...
        <View className=" pl-2 flex-1 flex-row justify-between">
          <Text className="text-[12px] text-white tracking-tighter ">{todo.dueDate.split("T")[0]}</Text><Text className="font-bold tracking-tighter  text-[12px] text-white">{todo.dueTime.slice(0, 5)}</Text>
        </View>
      </View>
